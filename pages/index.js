...
document.addEventListener("DOMContentLoaded", function() {
  ...
  document.querySelector(".js-negara").textContent = "${data.info.negara}";
  document.querySelector(".js-episode").textContent = "${data.info.episode}";
  document.querySelector(".js-network").textContent = "${data.info.network}";
  document.querySelector(".js-tanggalrilis").textContent = "${data.info.tanggalRilis}";
  document.querySelector(".js-season").textContent = "${data.info.season}";
  document.querySelector(".js-type").textContent = "Donghua";
  document.querySelector(".js-genre").textContent = "${data.info.genre}";
});
</script>
